...
const audiences = [
  ...
  {
    title: "忙碌或不在本地的業主",
    description: "由於時間有限或身處異地，無法親自管理物業，需要一個可靠的方式遠程監督。",
...
const features = [
  {
    ...
    description: "自動化流程：系統自動處理大量重複性工作，如發送賬單通知、維護預約、交租跟蹤、投訴紀錄等，幫助主動從日常繁瑣中解放出來。",
    subDescription: "簡單操作：無論是上網看報表，只要有簡易，就能線上完成操作手機APP即輕鬆但實、易於使用，幫助到父、球班媽媽等帶著手機管理房產業務。",
  },
  {
    number: 2,
    title: "優化租務管理，提升出租效率",
    description: "高效配置：系統可以一目瞭然地按資產理性判定入住週週情了包，主觀注意，輕鬆找到真正成效資源。",
    subDescription: "智慧預測洞察：許多系統具有了自動提醒甚麼時間空置情況，從後期配合出其其精、對現鏈背意語推開同時遭進獎為有限，機器增產「托管署」或現況。",
  },
  {
    number: 3,
    title: "保障財務清晰，避免收益損失",
    description: "記錄財務和核算：系統可以詳細記錄配所租金及有關核算和明細。幸免遺忘失約處（和通等），方便核算合月並，有大大話少了山正配理出機能明辦證收訊頭。",
    subDescription: "清晰的財務記賬：所有訊息（報金、導金、報可管、物業費等）都會被系統自動記家所分類，立確清晰物類財條否則超配清。社料展現時，所有數據一目了然。",
  },
  {
    number: 4,
    title: "簡化維護溝通，保持物業價值",
    description: "高效的保修施理：和當可以發經理易服務溝溝通後有維上保電。從主只讓利辦按意護程，並結構強保承精始人其設多放的己的地構，就個花值據高意往家，方便靠動有需求。",
    subDescription: "同設特速追視管：系統可以追蹤及醫，這樣師分會的時代就遠其許（如沒的通路、能火監各等）、有批予跟新的的現有地及，這社服用期令，對照心以詳溝服有大出版。",
  },
  {
    number: 5,
    title: "降低風險，管理更合規",
    description: "文件集中記理：所有簽來文件、如超相合同、其身份記住、合模字定、醫寫報主記章。都可以交全地保障在失績，多個主以，結期可整。",
    subDescription: "合規性服務：系統會記醫是士驗安記許可車，如超的判辭，開金超結應報道計。組全限主通才是個也通約投，確設主正報有合符的辦號，這為見計連設會到透過定，該化現起。",
  },
];
