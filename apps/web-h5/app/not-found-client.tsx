...
import { Button, Icon } from '@go-tech/web-ui';
      ...
      <div className="relative w-full max-w-md text-center">
        ...
        <div className="p-8">
          ...
          <div className="bg-primary/10 mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl">
            <Icon className="text-primary h-7 w-7" icon="lucide:compass" />
          </div>
          ...
          <div className="flex flex-col gap-2.5 sm:flex-row sm:justify-center">
            <Button asChild className="shadow-sm">
              <Link href="/">
                <Icon className="mr-2 h-4 w-4" icon="lucide:home" />

                {t('backHome')}
              </Link>
            </Button>

            <Button color="carbon" variant="outline" onClick={() => window.history.back()}>
              <Icon className="mr-2 h-4 w-4" icon="lucide:arrow-left" />
        ...
        <div className="text-muted-foreground/60 mt-10 text-xs">
          ...
          >
            ...
            <Icon className="ml-0.5 h-3 w-3" icon="lucide:external-link" />
          </a>
        </div>
      </div>
    </div>
