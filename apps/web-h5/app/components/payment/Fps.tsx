...
import { Button, FileUpload, Label, toast, UploadedFile } from "@go-tech-frontend/ui";
import {
  Banknote,
  Check,
  Copy,
  ...
  return (
    <div className="space-y-6 py-4">
      ...
      <div className="space-y-3">
        ...
        <FileUpload headers={headers} uploadUrl="/pms-resource/web-back/minio/upload" maxCount={1} onChange={handleFileChange} />
      </div>
