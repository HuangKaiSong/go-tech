...
const SelectTenant = ({
  ...
  return (
    <>
      <div className="h-9 w-32 text-xs flex items-center justify-center cursor-pointer text-foreground" onClick={() => {
        if (hasIframe) {
        ...
        <div className="container h-full mx-auto flex flex-row items-center gap-10">
            ...
            <div className="grid grid-cols-2 text-sm text-white/80">
              ...
              >
                ...
                <div className="flex flex-col">
                  <div
                    data-block-id="common-info"
                    data-block-role="phoneTitle"
                  >
                    Call Us
                  </div>
                  <div
                    data-block-id="common-info"
                    data-block-role="phoneValue"
                  >
                    {phoneValue}
                  </div>
                </div>
              ...
              >
                ...
                <div className="flex flex-col">
                  <div
                    data-block-id="common-info"
                    data-block-role="emailTitle"
                  >
                    Mail To Us
                  </div>
                  <div
                    data-block-id="common-info"
                    data-block-role="emailValue"
                  >
                    {emailValue}
                  </div>
                </div>
          ...
          <div className="basis-50 flex flex-col h-full py-4 justify-between">
            ...
            <div className="flex flex-row bg-background items-center rounded-l-sm rounded-r-lg">
              {hasTenant ? (
                  <>
                    <SelectTenant generateCallback={generateCallback}></SelectTenant>
                    <Button
                      size="sm"
                      disabled={!isLoggedIn}
