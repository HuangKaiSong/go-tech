...
import { Award, CheckCircle, Clock, Download, GraduationCap, Loader2, Search, Users } from 'lucide-react';
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            >
              <SelectTrigger className="w-[180px]">
                <SelectValue placeholder={t('培訓計劃')} />
              </SelectTrigger>
              <SelectContent>
            ...
            <TableBody>
              {rows.map((r: TrainingRecord) => (
                <TableRow key={r.id}>
                  ...
                  <TableCell>
                    <Badge variant="outline" className={statusColors[r.pStatusText]}>
                      {t(r.pStatusText)}
                    </Badge>
                  </TableCell>
                  <TableCell>
                    <Badge variant="outline" className={certColors[r.certificateText]}>
                      {t(r.certificateText)}
                    </Badge>
                  </TableCell>
