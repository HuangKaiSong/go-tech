...
import {
  ...
  CalendarDays, MapPin, ChevronRight, GraduationCap, BookUser
} from "lucide-react";
    ...
    <MobileLayout>
      ...
      <div className="px-5 mt-5">
        ...
        <div className="space-y-3">
          {[
            { title: "年假申請待審批", subtitle: "李小華 · 3/12-3/14", tag: "待審批", tagColor: "bg-warning/10 text-warning" },
            { title: "加班申請待確認", subtitle: "張大偉 · 3/10 18:00-21:00", tag: "待確認", tagColor: "bg-info/10 text-info" },
            { title: "三月份薪資已發布", subtitle: "點擊查看詳細薪資明細", tag: "新通知", tagColor: "bg-success/10 text-success" },
          ].map((item, i) => (
