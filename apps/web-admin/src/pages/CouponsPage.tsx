...
import { Calendar, Plus, Printer, Ticket, Upload } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-125">
          <DialogHeader>
            <div className="flex items-center justify-between">
              <DialogTitle className="text-lg font-medium">{isEditing ? '編輯優惠券' : '新增優惠券'}</DialogTitle>
              {/* Template icons */}
          ...
          {/* Button */}
          <Button className="w-full bg-primary hover:bg-primary/90" onClick={handleConfirm}>
            確認
          </Button>
        </DialogContent>
      </Dialog>
