        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-muted/50">
              ...
              <TableHead className="text-center font-medium">優惠碼開始日期</TableHead>
              <TableHead className="text-center font-medium">優惠碼結束日期</TableHead>
          ...
          <TableBody>
            {mockPromoCodes.map((code) => (
              <TableRow key={code.id} className="hover:bg-muted/30">
                ...
                <TableCell className="text-center">{code.target}</TableCell>
        ...
        <DialogContent className="sm:max-w-125">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="flex items-center gap-4">
              <label className="w-20 text-sm text-muted-foreground text-right shrink-0">优惠码名稱</label>
              <Input 
                placeholder="秋季優惠" 
                value={form.name}
