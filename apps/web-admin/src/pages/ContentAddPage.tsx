import { Button, Card, CardContent, CardHeader, CardTitle, Input, Label, Textarea } from '@go-tech-frontend/ui';
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-foreground">新增{type === 'image' ? '圖片' : '文字'}內容</h1>
        </div>
      </div>
            ...
            {type === 'image' ? (
              <div className="space-y-2">
                ...
                <div className="border-2 border-dashed border-border rounded-lg p-8 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">拖拽圖片到此處或點擊上傳</p>
