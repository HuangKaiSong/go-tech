...
import { Check, Eye, FilePlus, FileText, Minus, Plus, Receipt, RotateCcw, Search } from 'lucide-react';
import { useMemo, useRef, useState } from 'react';
import { useNavigate } from 'react-router-dom';
import Fps from '@/components/payment/Fps';
import { OrderItemTypeEnum, OrderStatusEnum, OrderStatusLabel, OrderTypeEnum, OrderTypeLabel } from '@/constants/order';
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center text-lg font-bold">
                ...
                <span className="text-primary">
                  ${(getUpgradePrice() - discountAmount + calculateUpgradeAddonsTotal()).toLocaleString()} HKD
                </span>
              </div>
            </div>
