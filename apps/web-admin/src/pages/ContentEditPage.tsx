...
const mockContentData: Record<string, {
  ...
  "2": {
    ...
    content: "我們是一家專業的服務公司，致力於為客戶提供最優質的產品與服務。我們的團隊由經驗豐富的專業人員組成，能夠滿足您的各種需求。",
    imageUrl: "",
  ...
  "3": {
    ...
    content: "歡迎使用我們的服務。使用本服務即表示您同意遵守以下條款與條件。請仔細閱讀這些條款，因為它們會影響您的法律權利。",
    imageUrl: "",
