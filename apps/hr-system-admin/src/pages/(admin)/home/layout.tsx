import { useAdminMenuBadges } from '@go-tech/web-admin-layouts';
...
const Home = () => {
  ...
  return (
    <ASpace className="w-full" orientation="vertical" size={[16, 16]} classNames={{ root: 'mb-4' }}>
      <HeaderBanner />
