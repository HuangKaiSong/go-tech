...
declare global {
  ...
  const AISupport: typeof import('../components/AISupport').default
  ...
  const APPROVAL_TYPE_OPTIONS: typeof import('antd').PPROVAL_TYPE_OPTIONS
  const ARow: typeof import('antd').Row
  const AScroll: typeof import('antd').Scroll
  ...
  const GoTechAvatar: typeof import('../components/GoTechAvatar').default
