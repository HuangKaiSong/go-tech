...
interface TaskAction {
  ...
  label: string;
  route?: string;
  type: 'link' | 'send' | 'upload'; // for upload type
}
...
const detailData: Record<string, OnboardingDetail> = {
  'OB-2026001': {
    ...
    tasks: [
      {
        name: '發送 Offer Letter',
        category: '文件簽署',
        done: true,
        dueDate: '2026-02-20',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳 Offer Letter', accept: '.pdf,.doc,.docx' },
        files: [{ name: 'Offer_趙明軒.pdf', size: '245 KB', uploadedAt: '2026-02-20' }]
      },
      {
        name: '勞動合約簽署',
        category: '文件簽署',
        ...
        dueDate: '2026-02-25',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳已簽合約', accept: '.pdf,.jpg,.png' },
        files: [{ name: '合約_趙明軒_signed.pdf', size: '1.2 MB', uploadedAt: '2026-02-25' }]
      },
      {
        name: '個人資料收集',
        category: '文件簽署',
        ...
        dueDate: '2026-02-28',
        assignee: '趙明軒',
        action: { type: 'link', label: '前往員工資料', route: '/employee-form' }
      },
      {
        name: '體檢報告',
        category: '文件簽署',
        ...
        dueDate: '2026-03-05',
        assignee: '趙明軒',
        action: { type: 'upload', label: '上傳體檢報告', accept: '.pdf,.jpg,.png' }
      },
      {
        name: '銀行帳戶開設',
        category: '薪資社保',
        ...
        dueDate: '2026-03-01',
        assignee: '趙明軒',
        action: { type: 'upload', label: '上傳銀行證明', accept: '.pdf,.jpg,.png' },
        files: [{ name: '銀行帳戶證明.jpg', size: '520 KB', uploadedAt: '2026-03-01' }]
      },
      {
        name: '社保公積金登記',
        category: '薪資社保',
      ...
      },
      {
        ...
        dueDate: '2026-03-03',
        assignee: '黃志偉',
        action: { type: 'upload', label: '上傳設備領取單', accept: '.pdf,.jpg,.png' },
        files: [{ name: '設備領取單_趙明軒.pdf', size: '180 KB', uploadedAt: '2026-03-03' }]
      },
      {
        name: '帳號權限開通',
        category: 'IT 設備',
      ...
      },
      {
        ...
        dueDate: '2026-03-05',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳工位平面圖', accept: '.pdf,.jpg,.png' },
        files: [{ name: '座位圖_3F-A12.png', size: '340 KB', uploadedAt: '2026-03-05' }]
      },
      {
        name: '門禁卡製作',
        category: '行政準備',
        ...
        dueDate: '2026-03-08',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳證件照', accept: '.jpg,.png' }
      },
      {
        name: '部門介紹與導師分配',
        category: '入職培訓',
        ...
        dueDate: '2026-03-10',
        assignee: '張小明',
        action: { type: 'link', label: '前往組織架構', route: '/organization/departments' }
      },
      {
        name: '新人培訓排程',
        category: '入職培訓',
        ...
        dueDate: '2026-03-10',
        assignee: '王美玲',
        action: { type: 'link', label: '前往培訓計劃', route: '/training/plans' }
      }
    ]
  },
  'OB-2026002': {
    ...
    tasks: [
      {
        ...
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳 Offer Letter', accept: '.pdf,.doc,.docx' },
        files: [{ name: 'Offer_吳雅婷.pdf', size: '230 KB', uploadedAt: '2026-02-28' }]
      },
      {
        name: '勞動合約簽署',
        category: '文件簽署',
        ...
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳已簽合約', accept: '.pdf,.jpg,.png' },
        files: [{ name: '合約_吳雅婷_signed.pdf', size: '1.1 MB', uploadedAt: '2026-03-05' }]
      },
      {
        name: '個人資料收集',
        category: '文件簽署',
        ...
        dueDate: '2026-03-08',
        assignee: '吳雅婷',
        action: { type: 'send', label: '發送填寫連結', route: '/employee-form' }
      },
      {
        name: '體檢報告',
        category: '文件簽署',
      ...
      },
      {
        ...
        assignee: '黃志偉',
        action: { type: 'upload', label: '上傳設備領取單', accept: '.pdf,.jpg,.png' },
        files: [{ name: '設備申請單_吳雅婷.pdf', size: '150 KB', uploadedAt: '2026-03-10' }]
      },
      {
        name: '帳號權限開通',
        category: 'IT 設備',
    ...
    tasks: [
      {
        ...
        dueDate: '2026-02-01',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳 Offer Letter', accept: '.pdf' },
        files: [{ name: 'Offer_鄭家豪.pdf', size: '240 KB', uploadedAt: '2026-02-01' }]
      },
      {
        name: '勞動合約簽署',
        category: '文件簽署',
        ...
        dueDate: '2026-02-05',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳已簽合約', accept: '.pdf' },
        files: [{ name: '合約_鄭家豪_signed.pdf', size: '1.3 MB', uploadedAt: '2026-02-05' }]
      },
      {
        name: '個人資料收集',
        category: '文件簽署',
        ...
        dueDate: '2026-02-08',
        assignee: '鄭家豪',
        action: { type: 'link', label: '查看員工資料', route: '/employee-form' }
      },
      {
        name: '體檢報告',
        category: '文件簽署',
        ...
        dueDate: '2026-02-10',
        assignee: '鄭家豪',
        action: { type: 'upload', label: '上傳體檢報告', accept: '.pdf' },
        files: [{ name: '體檢報告_鄭家豪.pdf', size: '890 KB', uploadedAt: '2026-02-10' }]
      },
      {
        name: '銀行帳戶開設',
        category: '薪資社保',
        ...
        dueDate: '2026-02-10',
        assignee: '鄭家豪',
        action: { type: 'upload', label: '上傳銀行證明', accept: '.pdf,.jpg' },
        files: [{ name: '銀行證明.pdf', size: '320 KB', uploadedAt: '2026-02-10' }]
      },
      {
        name: '社保公積金登記',
        category: '薪資社保',
      ...
      },
      {
        ...
        dueDate: '2026-02-12',
        assignee: '黃志偉',
        action: { type: 'upload', label: '上傳設備領取單', accept: '.pdf' },
        files: [{ name: '設備領取單.pdf', size: '160 KB', uploadedAt: '2026-02-12' }]
      },
      {
        name: '帳號權限開通',
        category: 'IT 設備',
      ...
      },
      {
        ...
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳工位平面圖', accept: '.pdf,.jpg,.png' },
        files: [{ name: '座位圖_2F-B05.png', size: '280 KB', uploadedAt: '2026-02-15' }]
      },
      {
        name: '門禁卡製作',
        category: '行政準備',
        ...
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳證件照', accept: '.jpg,.png' },
        files: [{ name: '證件照_鄭家豪.jpg', size: '95 KB', uploadedAt: '2026-02-18' }]
      },
      {
        name: '部門介紹與導師分配',
        category: '入職培訓',
    ...
    tasks: [
      {
        ...
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳 Offer Letter', accept: '.pdf,.doc,.docx' },
        files: [{ name: 'Offer_林詩涵.pdf', size: '235 KB', uploadedAt: '2026-03-05' }]
      },
      {
        name: '勞動合約簽署',
        category: '文件簽署',
  ...
  if (!detail) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-muted-foreground">
        ...
        <Button variant="link" onClick={() => navigate('/employees/onboarding')}>
          返回列表
        </Button>
      </div>
    );
