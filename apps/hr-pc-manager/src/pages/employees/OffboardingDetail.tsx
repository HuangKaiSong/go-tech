    ...
    tasks: [
      {
        ...
        dueDate: '2026-02-03',
        assignee: '林佳蓉',
        action: { type: 'upload', label: '上傳審批單', accept: '.pdf,.doc,.docx' },
        files: [{ name: '離職申請_周建華.pdf', size: '180 KB', uploadedAt: '2026-02-03' }]
      },
      {
        name: '部門主管確認',
        category: '審批流程',
        ...
        dueDate: '2026-02-05',
        assignee: '林佳蓉',
        action: { type: 'upload', label: '上傳確認函', accept: '.pdf' },
        files: [{ name: '主管確認函.pdf', size: '120 KB', uploadedAt: '2026-02-05' }]
      },
      {
        name: 'HR 審核',
        category: '審批流程',
        ...
        dueDate: '2026-02-07',
        assignee: '王美玲',
        action: { type: 'link', label: '查看員工檔案', route: '/employees' }
      },
      {
        name: '工作內容交接文件',
        category: '工作交接',
        ...
        dueDate: '2026-02-15',
        assignee: '周建華',
        action: { type: 'upload', label: '上傳交接文件', accept: '.pdf,.doc,.docx,.xlsx' },
        files: [{ name: '工作交接清單_周建華.xlsx', size: '450 KB', uploadedAt: '2026-02-14' }]
      },
      {
        name: '客戶/專案交接',
        category: '工作交接',
        ...
        dueDate: '2026-02-20',
        assignee: '周建華',
        action: { type: 'upload', label: '上傳客戶清單', accept: '.xlsx,.pdf' },
        files: [{ name: '客戶交接清單.xlsx', size: '680 KB', uploadedAt: '2026-02-18' }]
      },
      {
        name: '未完成工作確認',
        category: '工作交接',
        ...
        dueDate: '2026-02-25',
        assignee: '陳志豪',
        action: { type: 'upload', label: '上傳確認單', accept: '.pdf' }
      },
      {
        name: '電腦設備歸還',
        category: '資產歸還',
        ...
        dueDate: '2026-02-26',
        assignee: '黃志偉',
        action: { type: 'upload', label: '上傳歸還單', accept: '.pdf,.jpg,.png' }
      },
      {
        name: '門禁卡歸還',
        category: '資產歸還',
        ...
        dueDate: '2026-02-28',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳歸還記錄', accept: '.pdf,.jpg' }
      },
      {
        name: '辦公用品歸還',
        category: '資產歸還',
        ...
        dueDate: '2026-02-28',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳歸還清單', accept: '.pdf' }
      },
      {
        name: '公司資料清理',
        category: '資產歸還',
        ...
        dueDate: '2026-02-27',
        assignee: '黃志偉',
        action: { type: 'link', label: '前往系統設定', route: '/settings' }
      },
      {
        name: '系統帳號停用',
        category: '帳號權限',
      ...
      },
      {
        ...
        dueDate: '2026-02-20',
        assignee: '林佳蓉',
        action: { type: 'link', label: '前往薪資計算', route: '/payroll/calculate' }
      },
      {
        name: '最後薪資計算',
        category: '薪資結算',
      ...
      },
      {
        ...
        dueDate: '2026-03-01',
        assignee: '林佳蓉',
        action: { type: 'link', label: '前往薪資設定', route: '/payroll/structure' }
      },
      {
        name: '離職證明開立',
        category: '薪資結算',
        ...
        dueDate: '2026-03-01',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳離職證明', accept: '.pdf' }
      },
      {
        name: '離職面談安排',
        category: '離職面談',
        ...
        dueDate: '2026-02-22',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳面談紀錄', accept: '.pdf,.doc,.docx' },
        files: [{ name: '離職面談紀錄_周建華.pdf', size: '220 KB', uploadedAt: '2026-02-22' }]
      },
      {
        name: '離職問卷填寫',
        category: '離職面談',
    ...
    tasks: [
      {
        ...
        dueDate: '2026-02-18',
        assignee: '陳大偉',
        action: { type: 'upload', label: '上傳審批單', accept: '.pdf' }
      },
      {
        name: '部門主管確認',
        category: '審批流程',
      ...
      },
      {
        ...
        dueDate: '2026-03-12',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳面談紀錄', accept: '.pdf,.doc' }
      }
    ]
  },
  'OFF-2026003': {
    ...
    tasks: [
      {
        ...
        assignee: '李文華',
        action: { type: 'upload', label: '上傳審批單', accept: '.pdf' },
        files: [{ name: '離職申請_黃俊傑.pdf', size: '150 KB', uploadedAt: '2026-01-12' }]
      },
      {
        name: '部門主管確認',
        category: '審批流程',
        ...
        assignee: '李文華',
        action: { type: 'upload', label: '上傳確認函', accept: '.pdf' },
        files: [{ name: '主管確認函.pdf', size: '110 KB', uploadedAt: '2026-01-14' }]
      },
      {
        name: 'HR 審核',
        category: '審批流程',
      ...
      },
      {
        ...
        dueDate: '2026-01-25',
        assignee: '黃俊傑',
        action: { type: 'upload', label: '上傳交接文件', accept: '.pdf,.doc' },
        files: [{ name: '前端專案交接文件.pdf', size: '1.2 MB', uploadedAt: '2026-01-24' }]
      },
      {
        name: '電腦設備歸還',
        category: '資產歸還',
        ...
        dueDate: '2026-02-10',
        assignee: '黃志偉',
        action: { type: 'upload', label: '上傳歸還單', accept: '.pdf' },
        files: [{ name: '設備歸還單.pdf', size: '95 KB', uploadedAt: '2026-02-10' }]
      },
      {
        name: '門禁卡歸還',
        category: '資產歸還',
        ...
        dueDate: '2026-02-10',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳歸還記錄', accept: '.pdf' },
        files: [{ name: '門禁卡歸還記錄.pdf', size: '80 KB', uploadedAt: '2026-02-10' }]
      },
      {
        name: '系統帳號停用',
        category: '帳號權限',
      ...
      },
      {
        ...
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳離職證明', accept: '.pdf' },
        files: [{ name: '離職證明_黃俊傑.pdf', size: '160 KB', uploadedAt: '2026-02-11' }]
      },
      {
        name: '離職面談安排',
        category: '離職面談',
        ...
        dueDate: '2026-02-08',
        assignee: '王美玲',
        action: { type: 'upload', label: '上傳面談紀錄', accept: '.pdf' },
        files: [{ name: '離職面談紀錄.pdf', size: '200 KB', uploadedAt: '2026-02-08' }]
      }
    ]
  },
  'OFF-2026004': {
    ...
    tasks: [
      {
        ...
        assignee: '陳大偉',
        action: { type: 'upload', label: '上傳審批單', accept: '.pdf' },
        files: [{ name: '離職申請_張雅琳.pdf', size: '170 KB', uploadedAt: '2026-02-22' }]
      },
      {
        name: '部門主管確認',
        category: '審批流程',
        ...
        assignee: '陳大偉',
        action: { type: 'upload', label: '上傳確認函', accept: '.pdf' },
        files: [{ name: '主管確認函.pdf', size: '115 KB', uploadedAt: '2026-02-24' }]
      },
      {
        name: 'HR 審核',
        category: '審批流程',
      ...
      },
      {
        ...
        dueDate: '2026-03-05',
        assignee: '張雅琳',
        action: { type: 'upload', label: '上傳交接文件', accept: '.pdf,.doc,.xlsx' },
        files: [{ name: '行銷專案交接.xlsx', size: '520 KB', uploadedAt: '2026-03-04' }]
      },
      {
        name: '客戶/專案交接',
        category: '工作交接',
        ...
        assignee: '張雅琳',
        action: { type: 'upload', label: '上傳客戶清單', accept: '.xlsx,.pdf' },
        files: [{ name: '廠商合作清單.xlsx', size: '380 KB', uploadedAt: '2026-03-07' }]
      },
      {
        name: '未完成工作確認',
        category: '工作交接',
        ...
        assignee: '吳雅婷',
        action: { type: 'upload', label: '上傳確認單', accept: '.pdf' },
        files: [{ name: '工作確認單.pdf', size: '90 KB', uploadedAt: '2026-03-10' }]
      },
      {
        name: '電腦設備歸還',
        category: '資產歸還',
        ...
        dueDate: '2026-03-18',
        assignee: '黃志偉',
        action: { type: 'upload', label: '上傳歸還單', accept: '.pdf,.jpg' },
        files: [{ name: '設備歸還單.pdf', size: '100 KB', uploadedAt: '2026-03-17' }]
      },
      {
        name: '門禁卡歸還',
        category: '資產歸還',
        ...
        assignee: '李文華',
        action: { type: 'upload', label: '上傳歸還記錄', accept: '.pdf,.jpg' },
        files: [{ name: '門禁卡歸還.jpg', size: '75 KB', uploadedAt: '2026-03-19' }]
      },
      {
        name: '系統帳號停用',
        category: '帳號權限',
      ...
      },
      {
        ...
        assignee: '李文華',
        action: { type: 'upload', label: '上傳面談紀錄', accept: '.pdf,.doc' },
        files: [{ name: '離職面談紀錄_張雅琳.pdf', size: '210 KB', uploadedAt: '2026-03-15' }]
      },
      {
        name: '離職問卷填寫',
        category: '離職面談',
...
export default function OffboardingDetail() {
  ...
  const [uploadDialog, setUploadDialog] = useState<{ accept: string; label: string; open: boolean; taskIdx: number }>({
    open: false,
    taskIdx: -1,
    label: '',
    accept: ''
  ...
  if (!detail) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-muted-foreground">
        ...
        <Button variant="link" onClick={() => navigate('/employees/offboarding')}>
          返回列表
        </Button>
      </div>
    );
  ...
  const toggleTask = (index: number) => {
    ...
    toast.success(
      tasks[realIndex].done ? `已取消完成「${tasks[realIndex].name}」` : `已完成「${tasks[realIndex].name}」`
    );
  };
  ...
  const handleFileSelected = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setTasks(prev =>
      prev.map((t, i) =>
        i === uploadDialog.taskIdx
          ? {
              ...t,
              files: [
                ...(t.files || []),
                { name: file.name, size: sizeStr, uploadedAt: new Date().toISOString().split('T')[0] }
              ]
            }
          : t
      )
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 min-w-0 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-semibold">{activeCategory === 'all' ? '全部任務' : activeCategory}</h2>
          ...
          <div className="space-y-2">
            {filteredTasks.map((task, idx) => {
              ...
              const ActionIcon =
                ({ upload: Upload, send: Send } as Record<string, typeof Upload>)[task.action?.type ?? ''] ??
                ExternalLink;
              return (
                <div
                  key={`${task.name}-${idx}`}
      ...
      <Dialog
        ...
        onOpenChange={v => !v && setUploadDialog({ open: false, taskIdx: -1, label: '', accept: '' })}
      >
        <DialogContent className="max-w-md">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground mt-1">
              支援格式：{uploadDialog.accept || '所有格式'}，最大 10MB
            </p>
          </div>
          <input
            ref={fileInputRef}
          ...
          <DialogFooter>
            <Button
              variant="outline"
              onClick={() => setUploadDialog({ open: false, taskIdx: -1, label: '', accept: '' })}
            >
              取消
            </Button>
          </DialogFooter>
