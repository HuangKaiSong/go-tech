...
```bash
pnpm add @go-tech/adapter-antd-theme
```
...
import { derivative, derivativeDark } from '@go-tech/adapter-antd-theme';
...
```tsx
import { ConfigProvider } from 'antd';
import { defaultPresetColors, derivative, seedToken } from '@go-tech/adapter-antd-theme';
...
} from '@go-tech/adapter-antd-theme';
...
```ts
import { genColorMapToken } from '@go-tech/adapter-antd-theme';
import { generateNeutralColorPalettes } from '@go-tech/adapter-antd-theme';
...
```ts
import { generateColorPalettes } from '@go-tech/adapter-antd-theme';
...
```ts
import { genFontMapToken, FONT_SIZES, LINE_HEIGHTS } from '@go-tech/adapter-antd-theme';
...
```ts
import { genRadiusMapToken, genExtendedRadiusToken } from '@go-tech/adapter-antd-theme';
...
```ts
import { genSizeMapToken } from '@go-tech/adapter-antd-theme';
...
```ts
import { genPaletteVars, generateColorPalettes } from '@go-tech/adapter-antd-theme';
...
- [`@go-tech/color`](../../color) — OKLCH 调色板核心算法
- [`@go-tech/web-theme`](../web-theme) — Web 主题（配置、预设、hooks、CSS 变量）
- [`@go-tech/tailwind-plugin`](../tailwind-plugin) — Tailwind CSS 主题插件
