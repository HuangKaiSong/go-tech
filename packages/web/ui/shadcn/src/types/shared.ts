...
// Re-export shared cross-platform types from @go-tech/ui-types
export type {
  AcceptableValue,
  ClassValue,
  MaybeArray,
...
export interface PrimitiveProps {
   ...
   *
   * Read our [Composition](https://www.go-tech-ui.com/docs/guides/composition) guide for more details.
   */
  asChild?: boolean;
}
...
export type StyledComponentProps<T> = Omit<T, 'className'> & {
  ...
  size?: import('@go-tech/ui-types').ThemeSize;
};
