...
/** IndexedDB 数据库名称 */
export const IDB_DATABASE_NAME = 'go-tech_logs';
...
/** 设备 ID 存储键 */
export const DEVICE_ID_STORAGE_KEY = 'go-tech_device_id';

/** React Native AsyncStorage 日志键前缀 */
export const RN_LOG_KEY_PREFIX = 'go-tech_log_';

/** React Native AsyncStorage 日志索引键 */
export const RN_LOG_INDEX_KEY = 'go-tech_log_index';

/** 小程序日志文件目录 */
export const MP_LOG_DIRECTORY = 'go-tech_logs';
