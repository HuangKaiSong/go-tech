import type { RequestOption } from '@go-tech/axios';
import { createRequest } from '@go-tech/axios';
...
vi.mock('@go-tech/axios', async importOriginal => {
  const actual = await importOriginal<typeof import('@go-tech/axios')>();
  return {
    ...actual,
